...
export class Mountain {
  ...
  public spawn(
    ...
    mountainPolygon.setPosition(mountainPolygon.x + translationX, mountainPolygon.y + translationY);
    ...
    for (const pad of this.landingPads) {
      ...
      const labelText = scene.add
        .text(targetPadCenterX, targetPadCenterY - padH / 2 - 25, pad.name, { color: "gray" })
        .setOrigin(0.5, 0.5);
