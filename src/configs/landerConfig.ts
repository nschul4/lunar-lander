...
export const LANDER_VERTICES = [
  -20,
  20 + LANDER_Y_SHIFT, // Left-bottom wing tip
  0,
  10 + LANDER_Y_SHIFT, // Bottom-middle indent
  20,
  20 + LANDER_Y_SHIFT, // Right-bottom wing tip
  0,
  -20 + LANDER_Y_SHIFT, // Top nose cone tip
];
...
export const THRUST_VERTICES = [
  -20,
  20 + THRUST_Y_SHIFT, // Left edge meeting the left wing
  0,
  30 + THRUST_Y_SHIFT, // Bottom tip of the flame blowing downwards
  20,
  20 + THRUST_Y_SHIFT, // Right edge meeting the right wing
  0,
  10 + THRUST_Y_SHIFT, // Top tip of the flame tucked inside the ship indent
];
